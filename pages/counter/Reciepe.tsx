...
const Recipe = (props: ProductProps) => {
      ...
      <Box py={8}>
        ...
        <Stack direction="row" justifyContent="center" alignItems="center" spacing={2}>
          ...
          <Stack spacing={2}>
            ...
            <Typography mr={4}>Pinnabel iMac 24-Inch 4.5K Brand New | Apple M1 Chip | 8‑Core CPU | 7‑Core GPU | 8GB RAM | 256GB SSD | Silver | PN: MGTF3LL/A</Typography>
