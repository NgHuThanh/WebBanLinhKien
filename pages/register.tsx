...
const RegisterPage = () => {
    ...
    useEffect(() => {
      ...
      const firebaseConfig = {
        apiKey: "AIzaSyDA8Kz3MHG8a81MiPZUvnk_Mj5sB-jYSPg",
        authDomain: "test-b0e6b.firebaseapp.com",
        projectId: "test-b0e6b",
        storageBucket: "test-b0e6b.appspot.com",
        messagingSenderId: "298151524100",
        appId: "1:298151524100:web:8dd3ba2bbd9dfbf5c9c251",
        measurementId: "G-G238BMK8RH"
      };
            ...
            <FormGroup>
                <Stack spacing={4}>
                    ...
                    <TextField
                        ...
                        helperText={form.confirmPassword !== form.password ? "Passwords do not match" : ""}
